...
TerrainManager::TerrainManager(): scnMgn_(nullptr), terrainJson_(NULL)
{
}

TerrainManager::TerrainManager(Ogre::SceneManager * scnMgn, Ogre::Light * light, std::string terrainFile)
	: scnMgn_(scnMgn)
{
